...
const MOCKDATA = [
  { title: 'Email', description: 'soporte@ultra.garcia.cf', icon: At },
  { title: 'Teléfono', description: '+34 600123456', icon: Phone },
  { title: 'Dirección', description: 'Calle Mayor, 1', icon: MapPin },
  { title: 'Horas de soporte', description: '08:00 – 23:00', icon: Sun },
];
